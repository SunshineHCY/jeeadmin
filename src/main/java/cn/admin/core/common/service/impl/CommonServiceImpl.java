package cn.admin.core.common.service.impl;
...
import cn.admin.core.common.dao.support.OrderHelper;
...
import cn.admin.core.query.parse.CriteriaParse;
import cn.admin.core.query.parse.QueryParse;
import cn.admin.core.query.utils.QueryableConvertUtils;
import cn.admin.core.utils.ReflectionUtils;
...
public class CommonServiceImpl<T extends Serializable> implements ICommonService<T> {
	...
	@Override
	public Page<T> moreTableList(Queryable queryable, DetachedCriteria detachedCriteria, List list, Long total) {
		QueryParse<DetachedCriteria> queryParse = new CriteriaParse();
		QueryableConvertUtils.convertQueryValueToEntityValue(queryable, entityClass);
		queryParse.parseCondition(detachedCriteria, queryable);
		// 排序问题
		queryParse.parseSort(detachedCriteria, queryable);
		Pageable pageable = queryable.getPageable();
		return new PageImpl<T>(list, queryable.getPageable(), total);
	}
