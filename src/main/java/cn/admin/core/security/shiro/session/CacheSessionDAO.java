package cn.admin.core.security.shiro.session;
...
import cn.admin.core.utils.DateUtils;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
	...
	protected void doUpdate(Session session) {
		...
		if (request != null) {
			...
			// 如果是视图文件，则不更新SESSION
			if (StringUtils.startsWith(uri, jeeadminPropertiesUtil.getConfig("web.view.prefix"))
					&& StringUtils.endsWith(uri, jeeadminPropertiesUtil.getConfig("web.view.suffix"))) {
				return;
			}
			// 手动控制不更新SESSION
